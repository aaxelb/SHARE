...
class AbstractCreativeWork(AbstractShareObject):
    ...
    def resolve_total_related_agents(self):
        return self.agent_relations.filter(same_as__isnull=True).exact_count()
    ...
    def resolve_total_incoming_work_relations(self):
        return self.incoming_creative_work_relations.filter(same_as__isnull=True).exact_count()
    ...
    def resolve_total_outgoing_work_relations(self):
        return self.outgoing_creative_work_relations.filter(same_as__isnull=True).exact_count()
